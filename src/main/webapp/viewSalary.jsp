...
if(salDto!=null){%>
	...
	<table>
			...
			<tr>
				...
				<td><input type="text" name="HRA" value="<%=salDto.getHRA()%>"  readOnly/></td>
			</tr>
			<tr>
				<td><label>DA</label></td>
				<td><input type="text" name="DA"  value="<%=salDto.getDA()%>"  readOnly/></td>
			</tr>
			<tr>
				<td><label>MED</label></td>
				<td><input type="text" name="MED"  value="<%=salDto.getMED()%>" readOnly /></td>
			</tr>
			<tr>
				<td><label>PF</label></td>
				<td><input type="text" name="PF" value="<%=salDto.getPF()%>"   readOnly/></td>
			</tr>
			<tr>
				<td><label>Basic Salary</label></td>
				<td><input type="text" name="basicSalary" value="<%=salDto.getBasicSalary()%>"  readOnly  /></td>
			</tr>
